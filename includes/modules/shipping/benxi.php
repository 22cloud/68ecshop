...
$shipping_lang = ROOT_PATH.'languages/' .$GLOBALS['_CFG']['lang']. '/shipping/benxi.php';
...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    /* 插件作者的官方网站 */
    $modules[$i]['website'] = 'http://totliangb.github.io';
